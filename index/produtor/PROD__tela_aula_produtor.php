...
<body class="container">
    ...
    <?php
        ...
        echo "<h2 class='center-align bold'>$nome_aula
              ...
              <a href='../../___aulas/_D1_excluir_aula.php?id_aula=$id_aula'><i class='material-icons link-curso small'>delete</i></a></h2><br>";
                ...
                if($ext == "mp4"){
                    ...
                    echo "<h5><center>".$nome_material[$i]."</center></h5><video src='".$endereco_material[$i]."' controls width='100%'></video><br>
                        ...
                        <center><a href='../../__materiais/__U1_form_altera_material.php?id_material=". $id_material[$i] ."&id_aula=$id_aula'><div class='waves-effect waves-light btn btn-floating'><i class='material-icons'>edit</i></div></a>
                                <a href='../../__materiais/_D1_excluir_material.php?id_material=".$id_material[$i]."&id_aula=$id_aula'><div class='waves-effect waves-light btn btn-floating'><i class='material-icons'>delete</i></div></a></center><br>";
                    ...
                    echo "<h5>".$nome_material[$i]." <a href='".$endereco_material[$i]."' download class='white-text'><div class='waves-effect waves-light btn btn-floating'><i class='material-icons right'>download</i></div></a>
                          ...
                          <a href='../../__materiais/_D1_excluir_material.php?id_material=".$id_material[$i]."&id_aula=". $id_aula ."'><div class='waves-effect waves-light btn btn-floating'><i class='material-icons'>delete</i></div></a></h5><br>";
