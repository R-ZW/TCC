...
<body class="container">
        ...
        if(isset($id_curso)){
            ...
            for($i=0 ; $i<count($id_curso) ; $i++){
                ...
                echo "
                    ...
                    <a href='1____modificacao_curso.php?id_curso=" . $id_curso[$i] . "' class='link-curso'>
                        ...
                        <div class='card-panel hoverable'>
                            ...
                            <div class='center-align'><a href='1____form_altera_curso.php?id_curso=" . $id_curso[$i] . "&i=0' class='edita-exclui'><i class='material-icons small'>edit</i></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                <a href='1____excluir_curso.php?id_curso=" . $id_curso[$i] . "' class='edita-exclui'><i class='material-icons small'>delete</i></a></div>
    ...
    <div class='center-align'><a href='1____form_insere_curso.php?email=<?php echo $email;?>' class='btn-floating btn-large waves-effect waves-light'><i class='material-icons'>add</i></a></div>
